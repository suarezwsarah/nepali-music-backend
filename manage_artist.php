            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>                 
                  ...
                  <td><span class="category_img"><img src="images/thumbs/<?php echo $row['artist_image'];?>" /></span></td>
                  <td><a href="add_artist.php?artist_id=<?php echo $row['id'];?>" class="btn btn-primary">Edit</a>
                    <a href="?artist_id=<?php echo $row['id'];?>" class="btn btn-default" onclick="return confirm('Are you sure you want to delete this artist?');">Delete</a></td>
                </tr>
                <?php
