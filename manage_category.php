              ...
              <tbody>
                ...
                <tr>                 
                  ...
                  <td><a href="add_category.php?cat_id=<?php echo $row['cid'];?>" class="btn btn-primary">Edit</a>
                    <a href="?cat_id=<?php echo $row['cid'];?>" class="btn btn-default" onclick="return confirm('Are you sure you want to delete this category and related songs?');">Delete</a></td>
                </tr>
                <?php
