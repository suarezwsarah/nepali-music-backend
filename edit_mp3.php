                    ...
                    <div class="col-md-6">
                      <select name="mp3_artist[]" id="mp3_artist" class="select2 form-control" required multiple="multiple">
                        ...
                        <?php
                            ...
                            {
                        ?>                       
                        <option value="<?php echo $art_row['id'];?>" <?php if(in_array($art_row['id'], explode(",",$row['mp3_artist']))){?>selected<?php }?>><?php echo $art_row['artist_name'];?></option>
                        <?php
                          }
                        ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">                       
                      <select name="mp3_type" id="mp3_type" style="width:280px; height:25px;" class="select2" required>
                            <option value="">--Select Category--</option>                            
                            <option value="server_url" <?php if($row['mp3_type']=='server_url'){?>selected<?php }?>>From Server</option>
                            <option value="local" <?php if($row['mp3_type']=='local'){?>selected<?php }?>>From Local</option>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                       ...
                       <input type="hidden" name="mp3_thumbnail_name" id="mp3_thumbnail_name" value="<?php echo $row['mp3_thumbnail'];?>" class="form-control">
                            <div class="fileupload_img"><img type="image" src="images/<?php echo $row['mp3_thumbnail'];?>" alt="video thumbnail" /></div>
                          <?php } else {?>
